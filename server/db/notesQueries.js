...
const deleteNotesOfUser = async (props) => {
  return await db.query('DELETE FROM notes WHERE user_id = $1', props);
};

module.exports = { getNotes, postNote, putNote, deleteNote, deleteNotesOfUser };
